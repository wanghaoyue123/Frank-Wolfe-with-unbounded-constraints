...
### Original AwaystepCGG for least square
def Original_AwaystepCGG_Leastsquare(r, A, b, delta, itermax = 2000, cache_length = 300):
    ################################################################
    # Use the AwaystepCGG method for the problem
    #
    # minimize \|Ax - b\|_2^2
    # s.t. \|D^(r) x\|_1 <= delta
    #
