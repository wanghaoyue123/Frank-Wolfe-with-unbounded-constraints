...
def uFW_Leastsquare(r, A, b, delta, step_size, itermax = 2000, cache_length = 1000):
    ################################################################
    # Use the uFW method for the problem
    #
    # minimize \|Ax - b\|_2^2
    # s.t. \|D^(r) x\|_1 <= delta
    #
...
### Original CGG for least square
def Original_CGG_Leastsquare2(r, A, b, delta, step_size, itermax = 2000, cache_length = 300):
    ################################################################
